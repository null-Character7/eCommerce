            ...
            <div className='w-1/2 h-full bg-[##f5f5f5] flex flex-col p-20 justify-between'>
                <div className='w-full flex flex-col max-w-[500px]'>
                    ...
                    <div className='w-full flex flex-col my-4'>
                        <button onClick={submit} className='w-full text-white my-2 bg-[#060606] font-semibold rounder-md p-4 text-center flex items-center border-black justify-center cursor-pointer'>Log In</button>
                ...
                <div className='w-full items-center justify-center'>
                    <p className='text-sm font-normal text-[#060606]'>Don't have a account ? <span className='font-semibold underline underline-offset-2 cursor-pointer'><Link to='/register'>Sign Up for free</Link></span></p>
                </div>
            </div>
        </div>
    )
